...
class checks:
    ...
    def getLoadAvrgs(self):
        ...
        if sys.platform == 'linux2':
            ...
            self.checksLogger.debug('getLoadAvrgs: sunos5')
    ...
    def getMemoryUsage(self):
        ...
        if sys.platform == 'linux2':
            ...
            self.checksLogger.debug('getMemoryUsage: sunos5')

            try:
                self.checksLogger.debug('getMemoryUsage: attempting Popen prstat')
                ...
                usage = float(parts[3].replace('M', ''))
                swap_usage = float(parts[2].replace('M', ''))
